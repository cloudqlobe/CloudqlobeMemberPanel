...
const SaleCustomersPage = () => {
  ...
  const handleRowClick = (customerId) => navigate(`/member/SaleLead/customer/${customerId}`);
      ...
      <Layout>
        ...
        <div>
          ...
          >
            ...
            <Link to="/member/sale/customer/addlead"><span className="text-sm">ADD LEAD</span></Link>
            </button>
...
export default SaleCustomersPage;
