    ...
    <Layout>
      <div className="p-8 text-gray-900 min-h-screen">
        ...
        <div style={{ display: "flex", justifyContent: "space-between", textAlign: "center" }} className="space-x-4 mb-6">
          <button onClick={() => navigate("/member/account/addFollowup")} className="flex items-center bg-green-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-700">
...
export default AccountFollowUp;
